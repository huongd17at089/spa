...
CREATE TABLE `tbl_slot` (
  ...
  KEY `maspa_idx` (`maspa`),
  KEY `madv_idx` (`madv`),
  CONSTRAINT `maa` FOREIGN KEY (`maspa`) REFERENCES `tbl_spa` (`ma`),
  CONSTRAINT `mab` FOREIGN KEY (`madv`) REFERENCES `tbl_dichvu` (`ma`)
...
INSERT INTO `tbl_slot` VALUES (1,1,1,NULL),(2,1,2,NULL),(3,1,3,NULL),(4,1,4,NULL),(5,1,5,NULL),(6,2,1,NULL),(7,2,3,NULL),(8,2,4,NULL),(9,2,5,NULL);
